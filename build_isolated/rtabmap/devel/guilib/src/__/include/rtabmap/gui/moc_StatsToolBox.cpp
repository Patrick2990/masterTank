...
QT_MOC_LITERAL(4, 44, 18), // "std::vector<float>"
...
QT_MOC_LITERAL(10, 122, 18) // "preparePlotRequest"
    ...
    "valuesChanged\0std::vector<float>\0"
...
void rtabmap::StatItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (StatItem::*_t)(float );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StatItem::valueAdded)) {
                *result = 0;
            }
        }
        {
            typedef void (StatItem::*_t)(float , float );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StatItem::valueAdded)) {
                *result = 1;
            }
        }
        {
            typedef void (StatItem::*_t)(const std::vector<float> & , const std::vector<float> & );
...
QT_MOC_LITERAL(10, 104, 18), // "std::vector<float>"
QT_MOC_LITERAL(11, 123, 4), // "plot"
QT_MOC_LITERAL(12, 128, 15), // "const StatItem*"
QT_MOC_LITERAL(13, 144, 4), // "stat"
QT_MOC_LITERAL(14, 149, 8), // "plotName"
QT_MOC_LITERAL(15, 158, 13), // "figureDeleted"
QT_MOC_LITERAL(16, 172, 3) // "obj"

    },
    "rtabmap::StatsToolBox\0menuChanged\0\0"
    "const QMenu*\0figuresSetupChanged\0"
    "updateStat\0statFullName\0cacheOn\0y\0x\0"
    "std::vector<float>\0plot\0const StatItem*\0"
    "stat\0plotName\0figureDeleted\0obj"
};
#undef QT_MOC_LITERAL
...
static const uint qt_meta_data_rtabmap__StatsToolBox[] = {
 ...
 // slots: name, argc, parameters, tag, flags
       ...
       5,    4,   75,    2, 0x0a /* Public */,
       5,    4,   84,    2, 0x0a /* Public */,
      11,    2,   93,    2, 0x08 /* Private */,
      11,    1,   98,    2, 0x28 /* Private | MethodCloned */,
 ...
 // slots: parameters
    ...
    QMetaType::Void, QMetaType::QString, QMetaType::Float, QMetaType::Bool,    6,    8,    7,
    QMetaType::Void, QMetaType::QString, QMetaType::Float, QMetaType::Float, QMetaType::Bool,    6,    9,    8,    7,
...
void rtabmap::StatsToolBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->plot((*reinterpret_cast< const StatItem*(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 7: _t->plot((*reinterpret_cast< const StatItem*(*)>(_a[1]))); break;
        case 8: _t->figureDeleted((*reinterpret_cast< QObject*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
