...
public:
    ...
    void setupUi(QDialog *calibrationDialog)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 353, 816));
    ...
    void retranslateUi(QDialog *calibrationDialog)
    {
        ...
        label_15->setToolTip(QApplication::translate("calibrationDialog", "Number of inner squares on the board", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        label_21->setToolTip(QApplication::translate("calibrationDialog", "Number of inner squares on the board", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        label_22->setToolTip(QApplication::translate("calibrationDialog", "Number of inner squares on the board", 0));
#endif // QT_NO_TOOLTIP
