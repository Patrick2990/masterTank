...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'driver_base' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/plinux/RosPacks/masterTank/install_isolated/${idir}'.  Ask the maintainer 'Chad Rockey <chadrockey@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/plinux/RosPacks/masterTank/install_isolated/lib;/home/plinux/RosPacks/urg_node/devel/lib;/home/plinux/RosPacks/ork/devel/lib;/home/plinux/RosPacks/moveit/devel/lib;/home/plinux/RosPacks/usb_cam/devel/lib;/opt/ros/kinetic/lib)
