...
class RGBDImage {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = sensor_msgs.msg.CameraInfo.serialize(obj.cameraInfo, bufferInfo);
    ...
    bufferInfo = sensor_msgs.msg.CompressedImage.serialize(obj.rgbCompressed, bufferInfo);
    // Serialize message field [depthCompressed]
    bufferInfo = sensor_msgs.msg.CompressedImage.serialize(obj.depthCompressed, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    data.rgbCompressed = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [depthCompressed]
    tmp = sensor_msgs.msg.CompressedImage.deserialize(buffer);
    data.depthCompressed = tmp.data;
    buffer = tmp.buffer;
    return {
      data: data,
      buffer: buffer
