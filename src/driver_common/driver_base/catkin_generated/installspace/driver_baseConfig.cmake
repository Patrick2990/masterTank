...
if("FALSE" STREQUAL "TRUE")
  set(driver_base_SOURCE_PREFIX /home/thor/Dropbox/DTU_5_sem/MasterTank/src/driver_common/driver_base)
  set(driver_base_DEVEL_PREFIX /home/thor/Dropbox/DTU_5_sem/MasterTank/src/devel)
  ...
  set(driver_base_INSTALL_PREFIX /usr/local)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'driver_base' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'Chad Rockey <chadrockey@gmail.com>' to fix it.")
    endif()
