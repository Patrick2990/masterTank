...
namespace frontier_exploration {
    ...
    private:
        ...
        void executeCb(const frontier_exploration::ExploreTaskGoalConstPtr &goal) {
            ...
            std::cout << "from masterTank: " << goal->explore_boundary.polygon.points.at(0) << std::endl;
            std::cout << "from masterTank: " << goal->explore_boundary.polygon.points.at(1) << std::endl;
            std::cout << "from masterTank: " << goal->explore_boundary.polygon.points.at(2) << std::endl;
            std::cout << "from masterTank: " << goal->explore_boundary.polygon.points.at(3) << std::endl;
