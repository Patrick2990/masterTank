...
class GetMapResponse(genpy.Message):
  _md5sum = "a654e0522af879452f65b05b675851ab"
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.data.graph.links:
        ...
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        _x = val1
        buff.write(_get_struct_2f().pack(_x.rotVariance, _x.transVariance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.rotVariance, _x.transVariance,) = _get_struct_2f().unpack(str[start:end])
...
class GetMap(object):
  ...
  _md5sum = 'a497a5c12f80f2bb3fd9d80f0f51a2b5'
